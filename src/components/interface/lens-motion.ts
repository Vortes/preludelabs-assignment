...
export function useLensMotion(expanded: boolean, instant: boolean) {
  const controls = useDialKitController(
    "Exploded cube",
    {
      ...
      restWidth: [650, 400, 900, 1],
      restHeight: [230, 120, 500, 1],
      cubeSize: [462, 400, 650, 1],
      cubeDepth: [280, 280, 480, 1],
      cameraDistance: [2340, 1600, 3000, 10],
      artworkScale: [0.85, 0.5, 0.85, 0.01],
