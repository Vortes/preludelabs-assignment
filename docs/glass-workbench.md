...
The outer chat panel uses an 8% specular intensity and 0.7px inward falloff, calibrated to the faint rim in rest frame `4001:3945`. Cards and navigation pills retain their 20% lighting; the panel no longer uses the broad 80% highlight.
